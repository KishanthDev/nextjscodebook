...
export default function ChatHeader({ settings, isSaving }: Props) {
  ...
  return (
    <header className="p-3 border-b flex justify-between items-center bg-white dark:bg-gray-800" role="banner">
      <div className="flex items-center gap-2">
        ...
        <span
          ...
          aria-label={`Chat title: ${settings.chatTitle}`}
        >
          {settings.chatTitle}
        </span>
      </div>
      <nav aria-label="Chat widget controls" className="flex gap-2">
        <button
        ...
        <div className="relative">
          <button
            ...
            aria-controls="chat-dropdown-menu"
            ...
            >
              <div className="py-1">
                <button
                  ...
                  aria-label="Send chat transcript"
                >
                ...
                <button
                  ...
                  aria-label="Move chat to mobile"
                >
                  <svg viewBox="0 0 24 24" className="h-5 w-5 mr-2 fill-current" aria-hidden="true">
                ...
                >
                  <div className="flex items-center" id="sounds-label">
                    <svg viewBox="0 0 24 24" className="h-5 w-5 mr-2 fill-current" aria-hidden="true">
