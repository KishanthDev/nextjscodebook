        ...
        <footer className="bg-gray-100 text-black">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    ...
                    <div className="flex flex-wrap items-center mb-6">
                        ...
                        <p className="flex-1 min-w-[50%] sm:min-w-[33.33%] lg:min-w-[16.67%] mb-3">
                            <Link href="/app/livechat-web-app/" className="flex items-center text-xs text-black hover:text-white">
                        ...
                        <p className="flex-1 min-w-[30%] sm:min-w-[10.33%] lg:min-w-[10.67%] mb-3">
                            <Link href="/app/livechat-for-windows/" className="flex items-center text-xs text-black hover:text-white">
                                <svg width="15" height="15" xmlns="http://www.w3.org/2000/svg">
                                    <g fill="currentColor" fillRule="evenodd">
                        ...
                        <p className="flex-1 min-w-[50%] sm:min-w-[33.33%] lg:min-w-[16.67%] mb-3">
                            <Link href="/app/livechat-for-android/" className="flex items-center text-xs text-black hover:text-white">
                        ...
                        <p className="flex-1 min-w-[50%] sm:min-w-[33.33%] lg:min-w-[16.67%] mb-3">
                            <Link href="/app/livechat-for-iphone/" className="flex items-center text-xs text-black hover:text-white">
                        ...
                        <p className="flex-1 min-w-[50%] sm:min-w-[33.33%] lg:min-w-[16.67%] mb-3">
                            <Link href="/app/livechat-for-mac/" className="flex items-center text-xs text-black hover:text-white">
                                <svg width="15" height="18" xmlns="http://www.w3.org/2000/svg">
                                    <g fill="currentColor" fillRule="evenodd">
                                ...
                                <NavigationMenuList className="flex flex-col items-start justify-start space-y-2">
                                    {[
                                        ...
                                        <NavigationMenuItem key={item.href}>
                                            <Link
                                                href={item.href}
                                                className="text-xs text-black hover:text-white block"
                            ...
                            <NavigationMenu>
                                <NavigationMenuList className="flex flex-col items-start justify-start space-y-2">
                                    {[
                                        ...
                                        <NavigationMenuItem key={item.href}>
                                            <Link href={item.href} className="text-xs text-black hover:text-white block">
                                                {item.label}
                                            </Link>
                                        </NavigationMenuItem>
                                    ))}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
                <p className="text-[0.625rem] mb-3">
                    ...
                    <Link href="/solutions/ecommerce/" className="underline text-black hover:text-white">
                        ecommerce
                    </Link>{' '}
                ...
                <p className="text-[0.625rem]">
                    ...
                    <Link href="/legal/cookies-policy/" className="font-bold text-black hover:text-white">
                        Cookies Policy
                    </Link>{' '}
                    ...
                    <Link href="/legal/privacy-policy/" className="font-bold text-black hover:text-white">
                        Privacy Policy
                    </Link>.
                </p>
            </div>
